...
function seed(): DB {
  return {
    ...
    rewards: [
      ...
      { id: "r3", name: "Tumbler Eksklusif Oxygen.id", points_cost: 800, stock: 12, icon: "merch" },
      { id: "r4", name: "Voucher Gojek Rp25.000", points_cost: 250, stock: 30, icon: "ride" },
      { id: "r5", name: "Kaos Oxygen.id Official", points_cost: 1200, stock: 8, icon: "merch" },
    ],
    superAdmins: [
      { id: "sa1", username: "admin", password: "admin123", name: "Admin Pusat Oxygen.id" },
    ],
    logs: [
      {
        id: "l0",
