...
export default function App() {
  ...
  // Auto-save keuangan ke localStorage setiap kali berubah
  useEffect(() => {
    if (keuanganList.length > 0) localStorage.setItem('hutri81-keuangan', JSON.stringify(keuanganList));
  }, [keuanganList]);

  // Recalculate totalDana dari keuanganList
  useEffect(() => { setTotalDana(keuanganList.reduce((s, k) => s + (k.jumlah || 0), 0)); }, [keuanganList]);
