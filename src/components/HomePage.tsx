      ...
      <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_1fr]">
        ...
        >
          <img
            ...
            alt="Pria memegang router WiFi Oxygen.id"
        ...
        <div>
          ...
          <p className="mt-5 text-[15px] leading-8 text-slate-600">
            ...
            100% fiber optic Oxygen.id menghadirkan koneksi stabil untuk bekerja, belajar, streaming, hingga
            bermain game tanpa khawatir buffer. Atur paket sesuai gaya hidup Anda — harian, mingguan, atau
