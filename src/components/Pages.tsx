...
const addons = [
  ...
  { name: "OxyCool IoT", price: "Hubungi CS", desc: "Kontrol AC jarak jauh lewat aplikasi Oxygen.id." },
];
...
const homebases = [
  ...
  { city: "Palembang", address: "Cabang ke-14, Palembang" },
];
...
function NewsPage({ onOpenNews }: { onOpenNews: (id: string) => void }) {
  return (
    <PageShell eyebrow="NEWS" title="Kabar Terbaru Oxygen.id" subtitle="Promo, perluasan jaringan, dan cerita koneksi dari seluruh Indonesia.">
      <div className="grid gap-5 md:grid-cols-2">
        {newsList.map((n) => (
          <button
            key={n.id}
      ...
      <div className="grid gap-8 lg:grid-cols-[1.4fr_0.8fr]">
        ...
        <aside className="h-fit rounded-3xl bg-[#0b1d36] p-6 text-white">
          ...
          <ul className="mt-4 space-y-2 text-sm text-white/75">
            <li>1. Masuk ke Selfcare Oxygen.id</li>
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_0.85fr]">
        ...
        <div className="rounded-3xl bg-white p-6 shadow-lg sm:p-8">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-600">
            Cervino Village, Jl. KH Abdullah Syafei No.27
            <br />
...
function SubscribePage() {
  ...
  return (
    <PageShell
      ...
      title="Daftar Internet Oxygen.id"
...
function CheckAreaPage({ onSubscribe }: { onSubscribe: () => void }) {
  ...
  return (
    <PageShell
      eyebrow="CEK AREA"
      title="Cari Area Jangkauan Oxygen.id"
          ...
          <div className="mt-6 rounded-2xl bg-slate-50 p-5">
            {covered ? (
              ...
              <>
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Coba nama kecamatan lain, atau hubungi 1500 882 agar kami bantu cek manual.
                </p>
              </>
            )}
          </div>
...
function HomebasePage() {
  return (
    <PageShell
      ...
      subtitle="Kunjungi titik layanan Oxygen.id untuk konsultasi paket, pembayaran, dan bantuan teknis."
    >
      <div className="grid gap-4 md:grid-cols-2">
        {homebases.map((h) => (
          <div key={h.city} className="rounded-3xl bg-white p-6 shadow-lg">
            ...
            <p className="mt-3 text-sm font-bold text-oxy-teal">1500 882</p>
          </div>
        ))}
      </div>
    </PageShell>
